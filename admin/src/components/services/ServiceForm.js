...
const ServiceForm = () => {
    ...
    const onSubmit = (e) => {
        ...
        if (servicetitle === '' || menuname === '' || servicedetails === '') {
            ...
            setAlert('New Service Service Added', 'success');
            setLog({
                msg: 'A new service property was added',
                type: 'success',
            });
                        ...
                        <div className='col-xl-6'>
                            <div className='submit-field'>
                                ...
                                <input
                                    ...
                                    placeholder='Service Service Title'
                                />
                            </div>
                        </div>
                        <div className='col-xl-6'>
