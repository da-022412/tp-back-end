...
const EditForm = () => {
    ...
    const { clearPcurrent, updatePage, pcurrent, loading } = pageContext;
    ...
    const onGallery = async (e) => {
        ...
        try {
            ...
            var existingimages = newpage.gallery;
            var response = [];
    ...
    const removeImage = (e, _id) => {
        e.preventDefault();
        const newobj = newpage.gallery.filter((i) => _id !== i._id);
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        if (pagetitle === '' || pagesubt === '' || pagedetails === '') {
            ...
            setLog({
                msg: `The user tried to edit <b>${pcurrent.pagetitle}</b> without saving an extra box.`,
                type: 'error',
            });
        } else {
            setAlert('Page Page Updated', 'success');
            setLog({
                msg: `Page page <b>${pagetitle}</b> updated`,
                type: 'success',
            });
            updatePage(newpage);
                ...
                <div className='content with-padding'>
                                ...
                                <div className='input-with-icon'>
                                    <div id='autocomplete-container'>
                                        <input
                                            ...
                                            value={pagesubt}
                                            onChange={(e) => onChange(e)}
                                            placeholder='e.g. The best page on your area'
                                        />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='row' style={{ marginTop: 40 }}>
                        ...
                        <div className='col-xl-6'>
                            ...
                            >
                                <i className='icon-feather-plus'></i> Edit Page
                            </button>
                        </div>
                        <div className='col-xl-6'>
                            {pcurrent && (
